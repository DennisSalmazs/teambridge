...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        ProjectDTO project1 = new ProjectDTO("Spring MVC","PR001",user1, LocalDateTime.now(),LocalDateTime.now().plusDays(25),"Creating Controllers", Status.OPEN);
        ProjectDTO project2 = new ProjectDTO("Spring ORM","PR002",user2, LocalDateTime.now(),LocalDateTime.now().plusDays(10),"Creating Database", Status.IN_PROGRESS);
        ProjectDTO project3 = new ProjectDTO("Spring Container","PR003",user1, LocalDateTime.now(),LocalDateTime.now().plusDays(25),"Creating Container", Status.IN_PROGRESS);
